...
"color: yellow;")
        ...
        self.NotDealResButton.setStyleSheet("background-color: transparent;\n"
...
"border-radius: 15;")
        ...
        self.label_2.setPixmap(QtGui.QPixmap("./statics/imgs/right.png"))
        ...
        self.ResBugCountLabel.setStyleSheet("background-color: transparent;\n"
"color: red;")
...
"border: none;")
        ...
        self.label_5.setGeometry(QtCore.QRect(40, 20, 191, 31))
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(14)
        ...
        self.StopScanButton = QtWidgets.QPushButton(self.ScanningFrame)
        self.StopScanButton.setGeometry(QtCore.QRect(650, 35, 75, 23))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setUnderline(True)
        self.StopScanButton.setFont(font)
        self.StopScanButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.StopScanButton.setStyleSheet("background-color:transparent;\n"
