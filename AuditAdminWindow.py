...
# Form implementation generated from reading ui file 'AuditAdminWindow.ui'
#
...
"border: none;")
    ...
    def retranslateUi(self, AuditAdminWindow):
        ...
        self.SysSetButtonName.setText(_translate("AuditAdminWindow", "系统设置"))
        self.UserButtonName.setText(_translate("AuditAdminWindow", "用户管理"))
        ...
        self.ScanSetButton.setText(_translate("AuditAdminWindow", "病毒查杀"))
        self.AuthorizeSetButton.setText(_translate("AuditAdminWindow", "产品授权"))
        self.label_2.setText(_translate("AuditAdminWindow", "扫描类型："))
        self.label_3.setText(_translate("AuditAdminWindow", "处理方式："))
        self.label_4.setText(_translate("AuditAdminWindow", "扫描压缩包："))
        self.checkBox11.setText(_translate("AuditAdminWindow", "扫描PUA"))
        self.checkBox12.setText(_translate("AuditAdminWindow", "递归扫描目录"))
        self.checkBox13.setText(_translate("AuditAdminWindow", "扫描大于20M的文件"))
        self.radioButton21.setText(_translate("AuditAdminWindow", "手动处理"))
        self.radioButton22.setText(_translate("AuditAdminWindow", "自动处理"))
        self.checkBox31.setText(_translate("AuditAdminWindow", "进入压缩包扫描"))
        self.checkBox21.setText(_translate("AuditAdminWindow", "清除病毒前自动备份至恢复区（推荐）"))
        self.label.setText(_translate("AuditAdminWindow", "系统设置"))
        self.label_8.setText(_translate("AuditAdminWindow", "机器码："))
        self.label_9.setText(_translate("AuditAdminWindow", "ABCDE12345ABCDE12345ABCDE12345"))
        self.label_10.setText(_translate("AuditAdminWindow", "产品授权："))
        self.label_11.setText(_translate("AuditAdminWindow", "已经试用"))
        self.TryDaysNumberLabel.setText(_translate("AuditAdminWindow", "7"))
        self.label_13.setText(_translate("AuditAdminWindow", "天，请导出机器码！"))
        self.InputAuthorityButton.setText(_translate("AuditAdminWindow", "导入产品授权"))
        self.label_12.setText(_translate("AuditAdminWindow", "序号"))
        self.label_14.setText(_translate("AuditAdminWindow", "用户名"))
        self.label_15.setText(_translate("AuditAdminWindow", "账号类型"))
        self.label_17.setText(_translate("AuditAdminWindow", "帐号解锁"))
        self.label_18.setText(_translate("AuditAdminWindow", "更新周期"))
        self.label_19.setText(_translate("AuditAdminWindow", "重置密码"))
        self.label_24.setText(_translate("AuditAdminWindow", "1"))
        self.label_25.setText(_translate("AuditAdminWindow", "SecAdmin"))
        self.label_26.setText(_translate("AuditAdminWindow", "安全保密管理员"))
        self.label_28.setText(_translate("AuditAdminWindow", "已逾期"))
        self.SecUnlockButton.setText(_translate("AuditAdminWindow", "解锁"))
        self.SecResetButton.setText(_translate("AuditAdminWindow", "重置"))
        self.label_27.setText(_translate("AuditAdminWindow", "2"))
        self.label_29.setText(_translate("AuditAdminWindow", "AuditAdmin"))
        self.label_30.setText(_translate("AuditAdminWindow", "审计管理员"))
        self.label_31.setText(_translate("AuditAdminWindow", "已逾期"))
        self.AuditUnlockButton.setText(_translate("AuditAdminWindow", "解锁"))
        self.AuditResetButton.setText(_translate("AuditAdminWindow", "重置"))
        self.label_32.setText(_translate("AuditAdminWindow", "3"))
        self.label_33.setText(_translate("AuditAdminWindow", "Admin"))
        self.label_34.setText(_translate("AuditAdminWindow", "普通用户"))
        self.label_35.setText(_translate("AuditAdminWindow", "已逾期"))
        self.AdminUnlockButton.setText(_translate("AuditAdminWindow", "解锁"))
        self.AdminResetButton.setText(_translate("AuditAdminWindow", "重置"))
        self.label_16.setText(_translate("AuditAdminWindow", "用户管理"))
