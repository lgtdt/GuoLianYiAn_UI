...
# Form implementation generated from reading ui file 'SecAdminWindow.ui'
#
...
"border: none;")
    ...
    def retranslateUi(self, SecAdminWindow):
        ...
        self.SysSetButtonName.setText(_translate("SecAdminWindow", "系统设置"))
        self.UserButtonName.setText(_translate("SecAdminWindow", "用户管理"))
        ...
        self.ScanSetButton.setText(_translate("SecAdminWindow", "病毒查杀"))
        self.AuthorizeSetButton.setText(_translate("SecAdminWindow", "产品授权"))
        self.label_2.setText(_translate("SecAdminWindow", "扫描类型："))
        self.label_3.setText(_translate("SecAdminWindow", "处理方式："))
        self.label_4.setText(_translate("SecAdminWindow", "扫描压缩包："))
        self.checkBox11.setText(_translate("SecAdminWindow", "扫描PUA"))
        self.checkBox12.setText(_translate("SecAdminWindow", "递归扫描目录"))
        self.checkBox13.setText(_translate("SecAdminWindow", "扫描大于20M的文件"))
        self.radioButton21.setText(_translate("SecAdminWindow", "手动处理"))
        self.radioButton22.setText(_translate("SecAdminWindow", "自动处理"))
        self.checkBox31.setText(_translate("SecAdminWindow", "进入压缩包扫描"))
        self.checkBox21.setText(_translate("SecAdminWindow", "清除病毒前自动备份至恢复区（推荐）"))
        self.label.setText(_translate("SecAdminWindow", "系统设置"))
        self.label_8.setText(_translate("SecAdminWindow", "机器码："))
        self.label_9.setText(_translate("SecAdminWindow", "ABCDE12345ABCDE12345ABCDE12345"))
        self.label_10.setText(_translate("SecAdminWindow", "产品授权："))
        self.label_11.setText(_translate("SecAdminWindow", "已经试用"))
        self.TryDaysNumberLabel.setText(_translate("SecAdminWindow", "7"))
        self.label_13.setText(_translate("SecAdminWindow", "天，请导出机器码！"))
        self.InputAuthorityButton.setText(_translate("SecAdminWindow", "导入产品授权"))
        ...
        self.label_25.setText(_translate("SecAdminWindow", "SecAdmin"))
        ...
        self.label_27.setText(_translate("SecAdminWindow", "2"))
        self.label_29.setText(_translate("SecAdminWindow", "AuditAdmin"))
        self.label_30.setText(_translate("SecAdminWindow", "审计管理员"))
        self.label_31.setText(_translate("SecAdminWindow", "已逾期"))
        self.AuditUnlockButton.setText(_translate("SecAdminWindow", "解锁"))
        self.AuditResetButton.setText(_translate("SecAdminWindow", "重置"))
        self.label_32.setText(_translate("SecAdminWindow", "3"))
        self.label_33.setText(_translate("SecAdminWindow", "Admin"))
        self.label_34.setText(_translate("SecAdminWindow", "普通用户"))
        self.label_35.setText(_translate("SecAdminWindow", "已逾期"))
        self.AdminUnlockButton.setText(_translate("SecAdminWindow", "解锁"))
        self.AdminResetButton.setText(_translate("SecAdminWindow", "重置"))
